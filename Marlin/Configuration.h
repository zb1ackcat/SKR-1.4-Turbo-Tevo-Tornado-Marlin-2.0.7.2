...
#define STRING_CONFIG_H_AUTHOR "DJ - marlin 2" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Big White Ass Printer"
...
#define JD_HANDLE_SMALL_SEGMENTS    // for small segments (< 1mm) with large junction angles (> 135°).
#endif
