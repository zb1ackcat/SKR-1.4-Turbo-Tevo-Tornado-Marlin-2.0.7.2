...
#define CHAMBER_AUTO_FAN_PIN P2_04
...
#define X2_HOME_POS X2_MAX_POS // This is the default power-up mode which can be later using M605.
...
#define X_STALLCURRENT 1500 // L6474 - STALLCURRENT setting is used to set the nominal (TVAL) current
